...
<title>发起讨论-作业系统</title>
<meta name="keywords" content="发起讨论-作业系统">
<meta name="description" content="发起讨论-作业系统">
...
<section>
	<div class="mome">
		<form action="${ctx}/front/submitReply" method="post">
			...
			<input type="hidden" name="msgPid" value="0">
			<textarea name="msgContent" class="msg_content"></textarea>
			<div class="oper" style="background: #FFFFFF; margin-top: 1rem;">
				<a class="btn" style="margin-left: auto; margin-right: auto; width: 70%;display: block;" onclick="submitForm();">发起</a>
			</div>
		</form>
	</div>
</section>
